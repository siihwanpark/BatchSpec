...
from batchspec.profiler import Profiler, ProfilerConfig, register_active_profiler, release_active_profiler
...
def main():
    ...
    try:
        ...
        for prefix_len in args.prefix_len_list:
            print(f"\n{'='*80}")
            print(f"Running benchmark with prefix_len={prefix_len}")
            print(f"{'='*80}")
            ...
            batch_sampler = BatchSampler(
                ...
                margin_before_eos=5 * args.max_gen_len,
                pretokenize=True, 
                seed=args.seed
            )
