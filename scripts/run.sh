...
model_path=/home/mngcuser1/sihwan_workspace/checkpoints/Qwen3-8B/model.pth
tokenizer_path=/home/mngcuser1/sihwan_workspace/checkpoints/Qwen3-8B
...
torchrun --standalone --nproc_per_node=1 -m batchspec.run_e2e\
    --printoutput\
    --backend standard\
    ...
    --rank_group 0\
    --dataset AIME2025 --num_questions_in_prompt 1\
    --dtype bfloat16\
    --batch_size 16 --prefix_len 256 --max_gen_len 2048\
    --temperature 0.0
